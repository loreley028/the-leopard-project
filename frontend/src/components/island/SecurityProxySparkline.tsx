...
export function SecurityProxySparkline({ closes }: { closes: ViewerSecurityProxyRecentClose[] }) {
  if (!closes.length) return <p className="proxy-history-empty">近5日：暂无足够历史</p>;
  ...
  return <svg className="security-proxy-sparkline" viewBox="0 0 100 42" role="img" aria-label="近五个交易日收盘价走势">
