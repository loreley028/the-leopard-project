...
5. validates Phase 0, Phase 1A, Phase 1B-0, and Phase 1B-1 EOD/lineage/reconciliation policies;
...
The Node runtime deprecation annotation from the current upstream Actions is recorded as `ci_action_runtime_upgrade_pending`. Phase 1B-1 does not change Action versions unless CI itself fails.
