...
outside the 65-sector denominator.
...
Hotel/catering remains the explicit `881160` proxy. Intraday and historical
lineage include its canonical sector, proxy mapping type and symbol, Provider
identity, rationale, timestamp, and source status.
...
unless one normal Scheduler cycle produces 65/65 fresh snapshots, 65/65
